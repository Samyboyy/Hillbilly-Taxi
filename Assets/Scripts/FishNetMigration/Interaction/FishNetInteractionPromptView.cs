...
{
    /// <summary>
    /// Temporary code-generated interaction prompt. It keeps gameplay development
    /// independent from the final Hillbilly Taxi HUD art direction.
    /// </summary>
    [DisallowMultipleComponent]
    public sealed class FishNetInteractionPromptView : MonoBehaviour
    {
        [Header("Text")]
        ...
        private void EnsureBuilt()
        {
            ...
            _promptText.alignment =
                TextAnchor.MiddleCenter;

            _promptText.color = Color.white;
            _promptText.raycastTarget = false;

            _promptText.horizontalOverflow =
                HorizontalWrapMode.Overflow;

            _promptText.verticalOverflow =
